...
urlpatterns = patterns('',
    ...
    url(r'^games/new/(?P<nodename>[\w\.]+)/(?P<game_uuid>[\w-]+)$', 'game.views.newgame'),
    ...
    url(r'^canvas/(?P<canvas_id>[\w-]+)/$', 'game.views.canvas'),
    url(r'^canvas/(?P<canvas_id>[\w-]+)/diff$', 'game.views.canvasdiff'),
    url(r'^canvas/(?P<canvas_id>[\w-]+)/diff/(?P<timestamp>\d+)$', 'game.views.canvasdiff'),
    url(r'^guesses/$', 'game.views.guesses'),
    url(r'^guesses/(?P<timestamp>\d+)$', 'game.views.guesses'),
