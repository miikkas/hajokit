...
urlpatterns = patterns('',
    ...
    url(r'^player/create/(?P<playername>[\w ]+)/(?P<player_uuid>\s+)/(?P<nodename>[\w\.]+)$', 'game.views.newplayer'),
    url(r'^player/(?P<playerid>\d+)/join/(?P<gameid>\s+)$', 'game.views.joingame'),
    url(r'^player/(?P<playerid>\d+)/join/(?P<gameid>\s+)/(?P<nodename>[\w\.]+)$', 'game.views.joingame'),
    url(r'^games/new$', 'game.views.newgame'),
    url(r'^games/new/(?P<nodename>[\w\.]+)$', 'game.views.newgame'),
    url(r'^games/new/(?P<nodename>[\w\.]+)/(?P<game_uuid>\s+)$', 'game.views.newgame'),
    url(r'^games/$', 'game.views.listgames'),
    url(r'^games/(?P<gameid>\d+)/delete$', 'game.views.endgame'),
    url(r'^games/(?P<gameid>\d+)/delete/(?P<nodename>[\w\.]+)$', 'game.views.endgame'),
