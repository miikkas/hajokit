...
urlpatterns = patterns('',
    ...
    url(r'^player/(?P<playername>[\w ]+)$', 'game.views.player'),
    ...
    url(r'^canvas/(?P<canvas_id>[\w-]+)/clear/.*$', 'game.views.canvasclear'),
    url(r'^guesses/(?P<canvas_id>[\w-]+)/$', 'game.views.guesses'),
    url(r'^guesses/(?P<canvas_id>[\w-]+)/(?P<timestamp>\d+\.?\d*)$', 'game.views.guesses'),
